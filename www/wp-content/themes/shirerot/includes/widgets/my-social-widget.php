...
class My_SocialNetworksWidget extends WP_Widget {
	...
	function widget( $args, $instance ) {
		...
		?>
			...
			<?php foreach(array("Facebook", "Twitter", "Feed", "Google+") as $network) : ?>
	...
	function form( $instance ) {
		...
		$defaults = array( 'title' => '', 'twitter' => '', 'twitter_label' => '', 'facebook' => '', 'facebook_label' => '', 'feed' => '', 'feed_label' => '', 'google' => '', 'google_label' => '', 'display' => 'icons', 'text' => '');
