		...
		jQuery(function() {
			...
			if (!myCamera.hasClass('motopress-camera')) {
				...
				myCamera.camera({
					...
					height              : '26.5%', //here you can type pixels (for instance '300px'), a percentage (relative to the width of the slideshow, for instance '50%') or 'auto'
...
<div class="row">
	<div class="span12 separator-line_holder"><div class="separator-line"></div></div>
</div>