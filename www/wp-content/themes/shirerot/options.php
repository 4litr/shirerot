...
// ---------------------------------------------------------
			...
			$options['h1_heading'] = array(
								'id' => 'h1_heading',
								'std' => array( 'size' => '36px', 'lineheight' => '40px', 'face' => 'PT Sans, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
			...
			$options['h3_heading'] = array(
								'id' => 'h3_heading',
								'std' => array( 'size' => '26px', 'lineheight' => '30px', 'face' => 'PT Sans, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
			
			$options['h4_heading'] = array(
								'id' => 'h4_heading',
								'std' => array( 'size' => '21px', 'lineheight' => '18px', 'face' => 'PT Sans, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#f1cb38'));
								
			$options['h5_heading'] = array(
								'id' => 'h5_heading',
								'std' => array( 'size' => '16px', 'lineheight' => '20px', 'face' => 'PT Sans, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['logo_typography'] = array(
								'id' => 'logo_typography',
								'std' => array( 'size' => '70px', 'lineheight' => '70px', 'face' => 'Sail', 'style' => 'normal', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['menu_typography'] = array(
								'id' => 'menu_typography',
								'std' => array( 'size' => '22px', 'lineheight' => '26px', 'face' => 'PT Sans, sans-serif', 'style' => 'bold', 'character'  => 'latin', 'color' => '#ffffff'));
...
// ---------------------------------------------------------
			...
			$options['footer_menu_typography'] = array(
								...
								'std' => array( 'size' => '11px', 'lineheight' => '18px', 'face' => 'PT Sans, sans-serif', 'style' => 'normal', 'character'  => 'latin', 'color' => '#636262'));
		return $options;
	}
}
?>